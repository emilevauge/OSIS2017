    ...
    return (
      <Spectacle theme={theme}>
       <Deck transition={["slide"]} transitionDuration={200} theme={theme}>
          ...
          <Slide bgColor="white">
            <Image src={images.traefik.replace("/", "")} margin="0px auto 20px" fit height="400" />
      
            <Heading size={1} textColor="primary" >
              One Year Later
            </Heading>
   
            <Text margin="40" >Emile Vauge — OSIS 2017</Text>
          </Slide>
          ...
          <Slide >
            ...
            <Text >
            <Link href="https://emilevauge.github.io/OSIS2017">emilevauge.github.io/OSIS2017</Link>
            </Text>
          </Slide>
